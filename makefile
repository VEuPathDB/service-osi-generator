...
default:
	...
	@echo "    original state."
	@echo ""
	@echo "$(C_BLUE)  make api-test$(C_NONE)"
	@echo "    Performs functional tests against a test docker-compose build"
	@echo ""
...
# custom target for OSI generator; performs functional tests against test docker build
.PHONY: api-test
api-test:
